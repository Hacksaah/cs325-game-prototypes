...
BasicGame.GameTwo = function (game) {
...
BasicGame.GameTwo.prototype = {
    ...
    create: function ()
    {
        ...
        this.levelText = this.game.add.text(this.world.centerX - 50, 16, 'Level 2', { fontSize: '32px', fill: '#000' });
    ...
    update: function ()
    {
        this.bubble.body.velocity.y -= 1.0;
