...
BasicGame.GameThree = function (game) {
...
BasicGame.GameThree.prototype = {
    ...
    create: function ()
    {
        ...
        this.levelText = this.game.add.text(this.world.centerX - 50, 16, 'Level 3', { fontSize: '32px', fill: '#000' });
    ...
    update: function ()
    {
        this.bubble.body.velocity.y -= 1.1;
